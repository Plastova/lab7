...
1. tochn.py - сопоставляются приближенное решение, полученное в основновном задании, и точное решение, найденное с помощью онлайн-калькулятора.
...
![](/images/1.jpg)  
![](/images/2.jpg)  
и построены графики y(x), y'(x), фазовая траектория - y'(y). Была использована симметрическая неявная схема в связке с методом Эйлера, который позволил делать "предсказания" для схемы предиктор-корректор. Необходимый шаг был найден за 5 итерация от начального h=0.8 и оказался равен 0.025.
...
Разностные функции:  
![](/images/14.jpg)
- Приближенное решение и точное решение, найденное с помощью встроенной функции:  
